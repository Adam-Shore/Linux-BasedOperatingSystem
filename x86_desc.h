...
typedef union mb_t{
    uint32_t val;
    struct { //why is this md, this is also a killobyte of data 
        uint32_t p         : 1;
        uint32_t rw        : 1;
        uint32_t us        : 1;
        uint32_t pwt       : 1;
...
typedef union page_dir_entr_t {
    kb_t kb;
    mb_t mb;
    
} page_dir_entr_t;
 
typedef union page_tab_entr_t {
    uint32_t val;
    struct {
        uint32_t p         : 1;
        uint32_t rw        : 1;
...
//PAGING
page_dir_entr_t page_dir[NUM_PG_DIR] __attribute__((aligned(4096)));
page_tab_entr_t first_page_table[NUM_PG_DIR] __attribute__((aligned(4096)));
page_tab_entr_t video_mapping_page[NUM_PG_DIR] __attribute__((aligned(4096)));
